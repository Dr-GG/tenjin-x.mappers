...
public class TenjinXMapperServiceMoqExtensionsTests
{
    private const int ManyIterations = 100;

    private readonly Mock<ITenjinXMapperService> _mockMapper = new();
    ...
    public void SetupMapAndVerify_WithDestinationParameterAndNoCallback_ShouldMapToProvidedDestination(bool verifyWithDestination)
    {
        ...
        _mockMapper.SetupMap<TestSourceModel, TestDestinationModel>(providedDestination);
        _mockMapper.Object.Map(TestModelTestFixtures.EmptyTestSourceModel, incomingDestination);

        if (verifyWithDestination)
        {
            _mockMapper.VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once(), destination: incomingDestination);
        }
        else
        {
            _mockMapper.VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once());
        }
    ...
    public void SetupMapAndVerify_WithSourceAndDestination_ShouldMapToProvidedDestination(bool verifyWithDestination)
    {
        ...
        {
            _mockMapper.VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once(), source: source);
        }
    ...
    public void SetupMapAndVerify_WithMapNew_ShouldCreateNewDestinationObject(bool verifyWithDestination)
    {
        ...
        _mockMapper.SetupMapNew<TestSourceModel, TestDestinationModel>();
        _mockMapper.Object.MapNew<TestDestinationModel>(TestModelTestFixtures.EmptyTestSourceModel);

        if (verifyWithDestination)
        {
            _mockMapper.VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once(), destination: destination);
        }
        else
        {
            _mockMapper.VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once());
    ...
    public void SetupMap_WhenUsingMapNullable_WorksAsExpected()
    {
        ...
        _mockMapper.Object
            ...
            .MapNullable<TestSourceModel>(source1, null);

        _mockMapper
            .VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once(), source: source1)
            .VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once(), source: source2)
            .VerifyMap<TestSourceModel, TestDestinationModel>(Times.Never(), destination: incomingDestination3);
    ...
    public void SetupMap_WhenUsingMapNew_WorksAsExpected()
    {
        ...
        var result1 = _mockMapper.Object.MapNew<TestDestinationModel>(source1);
        var result2 = _mockMapper.Object.MapNew<TestDestinationModel>(source2);
    ...
    public void SetupMap_WhenUsingMapNullableNew_WorksAsExpected()
    {
        ...
        var result1 = _mockMapper.Object.MapNullableNew<TestDestinationModel>(source1);
        var result2 = _mockMapper.Object.MapNullableNew<TestDestinationModel>(source2);
        var result3 = _mockMapper.Object.MapNullableNew<TestDestinationModel>(null);
    ...
    public void SetupMapManyNew_WhenUsingMapManyToAnExistingCollection_WorksAsExpected()
    {
        ...
        for (var i = 0; i < ManyIterations; i++)
        {
            ...
            _mockMapper.VerifyMap<TestSourceModel, TestDestinationModel>(Times.Once(), source: mocks[i].Source);
        }
    ...
    public void SetupMapManyNew_WhenUsingMapManyToNewCollection_WorksAsExpected()
    {
        ...
        var sources = mocks.Select(x => x.Source);
        var results = _mockMapper.Object!.MapManyNew<TestDestinationModel>(sources).ToList();
