...
public static class TenjinXMapperServiceExtensions
{
    ...
    /// <summary>
    /// Maps the source to the destination with the default <see cref="IServiceProvider"/> instance.
    /// </summary>
    public static ITenjinXMapperService Map
    (
    ...
    {
        return mapper.Map(mapper.ServiceProvider, source, destination, context);
    }
